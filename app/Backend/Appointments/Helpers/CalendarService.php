...
class CalendarService extends ServiceDefaults
{
    ...
    private DateTimeImmutable $minTimePriorBooking;
    ...
    private function getStaffCalendar(): array
    {
        ...
        if ( ! $this->calledFromBackEnd )
        {
            ...
            $calculatedDateFrom = Date::epoch($this->isDateBasedService() ? Date::dateSQL() : 'now') + ( $minTimePriorBooking * 60 );
    ...
    private function initStaffCalendar(): void
    {
        ...
        $this->minTimePriorBooking = $this->getDatetimeImmutable( $this->isDateBasedService() ? Date::dateSQL() : 'now' )->modify( "+$minTimePriorBooking minutes" );

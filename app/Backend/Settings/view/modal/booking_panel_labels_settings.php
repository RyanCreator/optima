...
<div id="booknetic_settings_area">
    ...
    <script type="application/javascript"
            src="<?php echo Helper::assets('js/booking_panel_labels_settings.js', 'Settings') ?>"></script>
            ...
            <div class="select_langugage_section">
                <div>
                    ...
                    <button type="button" class="btn btn-default"
                            id="start_transaltion"><?php echo bkntc__('TRANSLATE') ?></button>
                    <?php if (Helper::isSaaSVersion()): ?>
                        <button type="button" class="btn btn-primary"
                                id="set_default_langugage"><?php echo bkntc__('SET AS DEFAULT LANGUAGE') ?></button>
                    <?php endif; ?>
                </div>
            </div>
                ...
                <div id="booknetic_panel_area" class="hidden">
                    <div class="booknetic_appointment">
                        <div class="booknetic_appointment_steps">
                            <div class="booknetic_appointment_steps_body nice-scrollbar-primary">
                                <div data-step-id="location"
                                     class="booknetic_appointment_step_element<?php echo(\BookneticApp\Providers\Core\Capabilities::tenantCan('locations') == false ? '_ hidden' : '') ?>">
                                    <span class="booknetic_badge">1</span>
                                    <span class="booknetic_step_title" data-translate="Location"></span>
                                    <img
                                            id="translate_edit_icon" alt="translate edit button"
                                            src="<?php echo Helper::icon('translate-edit.svg', 'Settings'); ?>"/>
                                    <div class="step-translate-buttons">
                                        <img id="translate_save_icon"
                                             src="<?php echo Helper::icon('translate-save.svg', 'Settings'); ?>"/>
                                        <img id="translate_cancel_icon"
                                             src="<?php echo Helper::icon('translate-cancel.svg', 'Settings'); ?>"/>
                                    </div>
                                </div>
                                <div data-step-id="staff"
                                     class="booknetic_appointment_step_element<?php echo(\BookneticApp\Providers\Core\Capabilities::tenantCan('staff') == false ? '_ hidden' : '') ?>">
                                    <span class="booknetic_badge">2</span>
                                    <span class="booknetic_step_title" data-translate="Staff"></span>
                                    <img
                                            id="translate_edit_icon" alt="translate edit button" class="ml-2"
                                            src="<?php echo Helper::icon('translate-edit.svg', 'Settings'); ?>"/>
                                    <div class="step-translate-buttons">
                                        <img id="translate_save_icon"
                                             src="<?php echo Helper::icon('translate-save.svg', 'Settings'); ?>"/>
                                ...
                                <div data-step-id="service"
                                     class="booknetic_appointment_step_element<?php echo(\BookneticApp\Providers\Core\Capabilities::tenantCan('services') == false ? '_ hidden' : '') ?>">
                                    <span class="booknetic_badge">3</span>
                                    <span class="booknetic_step_title" data-translate="Service"></span>
                                    <img
                                            id="translate_edit_icon" alt="translate edit button" class="ml-2"
                                            src="<?php echo Helper::icon('translate-edit.svg', 'Settings'); ?>"/>
                                    <div class="step-translate-buttons">
                                ...
                                <div data-step-id="service_extras"
                                     class="booknetic_appointment_step_element<?php echo(\BookneticApp\Providers\Core\Capabilities::tenantCan('services') == false ? '_ hidden' : '') ?>">
                                    <span class="booknetic_badge">4</span>
                                    <span class="booknetic_step_title" data-translate="Service Extras"></span>
                                    <img
                                            id="translate_edit_icon" alt="translate edit button" class="ml-2"
                                            src="<?php echo Helper::icon('translate-edit.svg', 'Settings'); ?>"/>
                                    <div class="step-translate-buttons">
                                ...
                                <div data-step-id="date_time" class="booknetic_appointment_step_element">
                                    <span class="booknetic_badge">5</span>
                                    <span class="booknetic_step_title" data-translate="Date & Time"></span>
                                    <img
                                            id="translate_edit_icon" alt="translate edit button" class="ml-2"
                                            src="<?php echo Helper::icon('translate-edit.svg', 'Settings'); ?>"/>
                                    <div class="step-translate-buttons">
                                ...
                                <div data-step-id="information" class="booknetic_appointment_step_element">
                                    <span class="booknetic_badge">6</span>
                                    <span class="booknetic_step_title" data-translate="Information"></span>
                                    <img
                                            id="translate_edit_icon" alt="translate edit button" class="ml-2"
                                            src="<?php echo Helper::icon('translate-edit.svg', 'Settings'); ?>"/>
                                    <div class="step-translate-buttons">
                                ...
                                <div data-step-id="cart" class="booknetic_appointment_step_element">
                                    <span class="booknetic_badge">8</span>
                                    <span class="booknetic_step_title" data-translate="Cart"></span>
                                    <img
                                            id="translate_edit_icon" alt="translate edit button" class="ml-2"
                                            src="<?php echo Helper::icon('translate-edit.svg', 'Settings'); ?>"/>
                                    <div class="step-translate-buttons">
                                ...
                                <div data-step-id="confirm_details" class="booknetic_appointment_step_element">
                                    <span class="booknetic_badge">7</span>
                                    <span class="booknetic_step_title" data-translate="Confirmation"></span>
                                    <img
                                            id="translate_edit_icon" alt="translate edit button" class="ml-2"
                                            src="<?php echo Helper::icon('translate-edit.svg', 'Settings'); ?>"/>
                                    <div class="step-translate-buttons">
                                ...
                                <div data-step-id="finish" class="booknetic_appointment_step_element">
                                    <span class="booknetic_badge">9</span>
                                    <span class="booknetic_step_title" data-translate="Finish"></span>
                                    <img
                                            id="translate_edit_icon" alt="translate edit button" class="ml-2"
                                            src="<?php echo Helper::icon('translate-edit.svg', 'Settings'); ?>"/>
                                    <div class="step-translate-buttons">
                                ...
                                <div data-step-id="other" class="booknetic_appointment_step_element">
                                    <span class="booknetic_badge">10</span>
                                    <span class="booknetic_step_title"><?php echo bkntc__('Other') ?></span>
                                </div>
                            </div>
                        ...
                        <div class="booknetic_appointment_container">
                            ...
                            <div class="booknetic_appointment_container_header hidden" data-step-id="location"><span
                                        data-translate="Select location"></span></div>
                            <div class="booknetic_appointment_container_header hidden" data-step-id="staff"><span
                                        data-translate="Select staff"></span></div>
                            <div class="booknetic_appointment_container_header hidden" data-step-id="service"><span
                                        data-translate="Select service"></span></div>
                            <div class="booknetic_appointment_container_header hidden" data-step-id="service_extras">
                                <span data-translate="Select service extras"></span></div>
                            <div class="booknetic_appointment_container_header hidden" data-step-id="information"><span
                                        data-translate="Fill information"></span></div>
                            <div class="booknetic_appointment_container_header hidden" data-step-id="date_time"><span
                                        data-translate="Select Date & Time"></span></div>
                            <div class="booknetic_appointment_container_header hidden" data-step-id="cart"><span
                                        data-translate="Add to cart"></span></div>
                            <div class="booknetic_appointment_container_header hidden" data-step-id="confirm_details">
                                <span data-translate="Confirm Details"></span></div>
                            ...
                            <div class="booknetic_appointment_container_body">
                                        ...
                                        <div class="booknetic_service_extra_card">
                                            ...
                                            <div class="booknetic_service_extra_quantity">
                                                ...
                                                <input type="text" class="booknetic_service_extra_quantity_input"
                                                       value="0"
                                                       data-max-quantity="<?php echo $extraInf->max_quantity ?>">
                                    ...
                                    <div class="booknetic_date_time_area">
                                        ...
                                        <div class="booknetic_time_div">
                                            ...
                                            <div class="booknetic_times">
                                                <div class="booknetic_times_title"><span
                                                            data-translate="Select date"></span></div>
                                ...
                                <div class="hidden" data-step-id="information">
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" id="bkntc_input_surname" class="form-control"
                                                   name="surname">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                    ...
                                    <div id="booknetic_bring_someone_section">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <label for=""><span
                                                            data-translate="Bring People with You"></span></label>
                                            </div>
                                                ...
                                                <div class="booknetic-cart-item">
                                                    <div class="booknetic-cart-item-header">
                                                        ...
                                                        <button class="booknetic-cart-item-more">
                                                            <img src="<?php echo Helper::icon('more-vertical.svg', 'front-end') ?>"
                                                                 alt="">
                                                        </button>
                                                    ...
                                                    <div class="booknetic-cart-item-body">
                                                        ...
                                                        <div class="booknetic-cart-item-body-row">
                                                            ...
                                                            <span class="booknetic-cart-item-body-cell"><div><span
                                                                            data-translate="Amount"></span></div>:</span>
                                                            ...
                                                            <span class="booknetic-cart-item-body-cell">
                                                                    <button class="booknetic-cart-item-info">
                                                                        <img src="<?php echo Helper::icon('info.svg', 'front-end') ?>"
                                                                             alt="">
                                                        ...
                                                        <div class="booknetic-cart-item-error ">
                                                            <div class="booknetic-cart-item-error-header">
                                                                <div>
                                                                    <img src="<?php echo Helper::icon('alert-triangle.svg', 'front-end') ?>"
                                                                         alt="">
                                        ...
                                        <div class="booknetic_confirm_sum_body<?php echo $parameters['hide_payments'] ? ' booknetic_confirm_sum_body_full_width' : ''; ?>">
                                            <div class="booknetic_portlet">
                                                ...
                                                <div class="booknetic_confirm_details" data-price-id="discount">
                                                    <div class="booknetic_confirm_details_title"><span
                                                                data-translate="Discount"></span></div>
                                        ...
                                        <div class="booknetic_confirm_deposit_body<?php echo $parameters['hide_payments'] ? ' hidden' : ''; ?>">
                                            ...
                                            <div class="booknetic_portlet">
                                                ...
                                                <div class="booknetic_deposit_radios">
                                                    <div>
                                                        <input type="radio" id="input_deposit_2" name="input_deposit"
                                                               value="1" checked><label><span
                                                                    data-translate="Deposit"></span></label>
                                                    </div>
                                                    <div>
                                                        <input type="radio" id="input_deposit_1" name="input_deposit"
                                                               value="0"><label><span
                                                                    data-translate="Full amount"></span></label>
                                                    </div>
                                                </div>

                                                <div class="booknetic_deposit_price">
                                                    <div><span data-translate="Deposit"></span>:</div>
                                                    <div class="booknetic_deposit_amount_txt">
                                                        20%, <?php echo Helper::price(20) ?></div>
                                                </div>
                                ...
                                <div class="hidden" data-step-id="finish">
                                    <div class="booknetic_appointment_finished">
                                        <div class="booknetic_appointment_finished_icon"><img
                                                    src="<?php echo Helper::icon('status-ok.svg', 'front-end') ?>">
                                        </div>
                                        <div class="booknetic_appointment_finished_title"
                                             data-translate="Thank you for your request!"></div>
                                        <div class="booknetic_appointment_finished_subtitle"
                                             data-translate="Your confirmation number:"></div>
                                        <div class="booknetic_appointment_finished_code">0123</div>
                                        <div class="booknetic_appointment_finished_actions">
                                            <button type="button" id="booknetic_add_to_google_calendar_btn"
                                                    class="booknetic_btn_secondary<?php echo Helper::getOption('hide_add_to_google_calendar_btn', 'off') == 'on' ? ' booknetic_hidden' : '' ?>">
                                                <img src="<?php echo Helper::icon('calendar.svg', 'front-end') ?>">
                                                <span data-translate="ADD TO GOOGLE CALENDAR"></span></button>
                                            <button type="button" id="booknetic_start_new_booking_btn"
                                                    class="booknetic_btn_secondary<?php echo Helper::getOption('hide_start_new_booking_btn', 'off') == 'on' ? ' booknetic_hidden' : '' ?>">
                                                <img src="<?php echo Helper::icon('plus.svg', 'front-end') ?>"> <span
                                                        data-translate="START NEW BOOKING"></span></button>
                                            <button type="button" id="booknetic_finish_btn"
                                                    class="booknetic_btn_secondary"
                                                    data-redirect-url="<?php echo htmlspecialchars(Helper::getOption('redirect_url_after_booking')) ?>">
                                                <img src="<?php echo Helper::icon('check-small.svg', 'front-end') ?>">
                                                <span data-translate="FINISH BOOKING"></span></button>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group col-md-12">
                                            <div class="input-group-prepend">
                                                ...
                                                <input type="text" class="form-control"
                                                       data-translate-key="<?php echo htmlspecialchars($translateKey) ?>"
                                                       value="<?php echo htmlspecialchars($translateTxt) ?>">
                                            </div>
                                        </div>
                                        <?php
                                    }
                            ...
                            <div class="booknetic_appointment_container_footer">
                                <button type="button" class="booknetic_btn_secondary booknetic_prev_step"><span
                                            data-translate="BACK"></span></button>
                                <button type="button" class="booknetic_btn_primary booknetic_next_step"><span
                                            data-translate="NEXT STEP"></span></button>
                            </div>
                        </div>
                    </div>
                </div>

...
<div class="form-row">
	...
	<div class="form-group col-md-6<?php echo $parameters['show_only_name'] ? ' booknetic_hidden bkntc_hidden_lastname' : ''?>" data-bkntc-customer-info="true">
...
<div class="form-row booknetic_hidden bkntc-information-step-info-container" data-bkntc-customer-id="true">
    <div class="form-group col-md-12">
        ...
        <div><?php echo bkntc__("An account already exists in our system.")?></div>
    </div>
</div>
